...
- **Radar** (`dist/radar.html`) ranks a separate universe of retained Coin contracts and discovered pools for swing and longer-term research. Its heuristic scores expose missing inputs and stale observations.
