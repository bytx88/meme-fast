...
function scannerRow(c,index){
 ...
 const stage=stageFor(c),stageLabel=c.ruggedAt?'Rugged':stage==='migrated'&&isUnderObservation(c)?'Observing':({new:'New',stretch:'Stretch',migrated:'Migrated',sustained:'Sustained'}[stage]||'New');
...
function render(){
 ...
 visibleRows=state.view==='discover'?[...stages.stretch,...stages.new,...stages.sustained,...stages.tracking,...stages.migrated]:rows;
