...
function scannerRow(c,index){
 const found=context(c),market=marketState(c),trade=axiomLink(c),label=contextLabel(found),badge=verified(found)?'verified':found?'unverified':'pending',read=quickRead(found,c);
